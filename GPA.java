void main() {
    ...
    IO.print("--- เริ่มการคำนวณเกรด (รองรับ + และ E) ---");
    ...
    for (int i = 0; i < grades.length; i++) {
        ...
        switch (grade) {
            ...
            case "E":
                ...
                IO.print("วิชาที่ " + (i + 1) + " (เกรด E): ไม่นำมาคำนวณ");
                isCalculated = false;
                break;

            default:
                IO.print("ไม่พบข้อมูลเกรด: " + grade);
                isCalculated = false;
        }
        ...
        if (isCalculated) {
            ...
            IO.print("วิชาที่ " + (i + 1) + " (เกรด " + grade + "): ได้แต้ม " + currentPoints);
        }
    }
